...
iframe = driver.find_element(By.CSS_SELECTOR, ".unLoginSd_application_iframe > iframe")
# switch to selected iframe, else won't find button
...
driver.switch_to.frame("frameServer")   # IMPORTANT, else don't work
service = driver.find_element(by=By.ID, value="1929")   # find health app
...
driver.find_element(by=By.ID, value="input_swtw").send_keys(temperature)
